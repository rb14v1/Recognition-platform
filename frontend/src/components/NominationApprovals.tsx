...
const NominationApprovals = () => {
  ...
  return (
    <div className="animate-fadeIn max-w-5xl mx-auto">
      ...
      {/* TABS WITH TEAL COLOR */}
      <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 4 }}>
        <Tabs
          value={activeTab}
          onChange={(_, v) => setActiveTab(v)}
          TabIndicatorProps={{
            style: { backgroundColor: "#00A8A8" } // TEAL underline
          }}
          sx={{
            "& .MuiTab-root": {
              textTransform: "none",
            ...
            "& .Mui-selected": {
              color: "#00A8A8 !important", // TEAL selected
            },
            "& .MuiTab-iconWrapper": {
              color: "#6b7280", // gray icons
            },
            "& .Mui-selected .MuiTab-iconWrapper": {
              color: "#00A8A8", // TEAL selected icon
            }
          }}
        >
        ...
        <div className="space-y-4">
          {nominations.map(nom => (
            <Card 
              ...
              sx={{ 
                borderRadius: 3, 
                borderLeft: activeTab === 0 
                    ? "6px solid #00A8A8"   // TEAL for pending
                    : "6px solid #cbd5e1",  // Gray for history
                overflow: "visible" 
              }}
            >
